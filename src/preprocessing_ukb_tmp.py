...
def main(config):
    ...
    for i in tqdm(range(len(df))):
        subject = str(df['id'][i])
        process_subject(root, subject, atlas_template_path, save_root, regions, df, trial, tmp_path, skip)
        gc.collect()
